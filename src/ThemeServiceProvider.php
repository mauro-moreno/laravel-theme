...
class ThemeServiceProvider extends ServiceProvider
{
    public function register()
    {
        ...
        | Bind in IOC
        |--------------------------------------------------------------------------*/
        $this->app->singleton('mauro-moreno.themes', function() {
            return new Themes();
        });
        ...
        $this->app->singleton('view.finder', function($app) {
            ...
            return new ThemeViewFinder($app['files'], $paths, null, $app['mauro-moreno.themes']);
        });

        /*--------------------------------------------------------------------------
        | Initialize Themes
        |--------------------------------------------------------------------------*/
        $themes = $this->app->make('mauro-moreno.themes');
    ...
    public function boot()
    {
        ...
        |--------------------------------------------------------------------------*/
        $this->publishes([
            __DIR__ . '/../resources/config.php' => config_path('themes.php'),
        ]);
